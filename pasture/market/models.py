...
class MacroMaster(TimeStampable, models.Model):
    ...
    category = models.CharField(max_length=50, help_text="category", null=True, blank=True)
    sub_category = models.CharField(max_length=100, help_text="sub category", null=True, blank=True)
